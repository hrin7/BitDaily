        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('${pageContext.request.contextPath}/images/banana.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>식단 기록</h3><br>
              <p><button onclick="location.href='${pageContext.request.contextPath}/diary/diary.do?page=1'">ViewMore</button></p>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('${pageContext.request.contextPath}/images/bicycle.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>운동 기록</h3><br>
              <p><button onclick="location.href='${pageContext.request.contextPath}/diary/diary.do?page=2'">ViewMore</button></p>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('${pageContext.request.contextPath}/images/pencil.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>다이어트 일기</h3><br>
              <p><button onclick="location.href='${pageContext.request.contextPath}/diary/diary.do?page=3'">ViewMore</button></p>
            </div>
          </div>
        </div>

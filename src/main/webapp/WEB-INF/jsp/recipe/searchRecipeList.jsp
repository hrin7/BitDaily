...
<div>
	...
	<form class="search-container" action="<c:url value='/recipe/searchList.do'/> ">
	    <input type="text" id="search-bar" name="title" placeholder="레시피 검색">
	    <input type="image" class="search-icon" src="<c:url value='/images/icon/search2.png'/> ">
	</form>
	<div id="clear"></div>
</div>
<div id="outer">

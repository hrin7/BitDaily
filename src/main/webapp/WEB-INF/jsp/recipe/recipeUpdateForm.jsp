...
<div id="outer">
	<div class="content-box">
		...
		<form id="form" class="topBefore" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/recipe/update.do">
		  ...
		  <input id="name" type="text" name="title" placeholder="TITLE" value="${recipe.title}">
		  <textarea id="message" type="text" name="content" placeholder="CONTENT">${recipe.content}</textarea>
